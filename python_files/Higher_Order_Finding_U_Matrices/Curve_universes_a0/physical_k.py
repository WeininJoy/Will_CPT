...
np.save('/home/wnd22/Documents/Research/Will_CPT/python_files/Higher_Order_Finding_U_Matrices/Curve_universes_a0/s0', s0_list)

mt_list = np.linspace(300, 450, 10)
kt_list = np.linspace(1.e-4, 1, 10)
s0 = np.load('/home/wnd22/Documents/Research/Will_CPT/python_files/Higher_Order_Finding_U_Matrices/Curve_universes_a0/s0.npy')
...
for i in range(10):
    for j in range(10):
        ...
        deltaKphys = deltaK * s0[10*i+j] * np.sqrt(Lambda)
