...
########### calculate allowedK ##############
# kvalues_all_k_0_30 = np.linspace(1e-5,30,num=300); # data_all_k_0-30
# kvalues_all_k_30_70 = np.linspace(30,70,num=400); # data_all_k_30-70
# kvalues_small_k = np.linspace(1e-5,3,num=100); # data_small_k
# calculate_allowedK(params, z_rec, kvalues=kvalues_all_k_0_30, folder_path=folder+'data_all_k_0-30/')
# calculate_allowedK(params, z_rec, kvalues=kvalues_all_k_30_70, folder_path=folder+'data_all_k_30-70/')
...
allowedK_path = folder + 'data_all_k_0-30/allowedK.npy'
...
kvalues_allowedK_30_70 = np.load(folder + 'data_all_k_30-70/allowedK.npy')
kvalues_allowedK = np.concatenate((kvalues_allowedK, kvalues_allowedK_30_70))  # add high k values from the second range
print('kvalues_allowedK:', kvalues_allowedK)
plt.plot(np.diff(kvalues_allowedK))
plt.xlabel('Index')
plt.ylabel('Delta k')
plt.savefig('allowedK_spacing.pdf')


# ## kvalues based on allowedK_integer
# small_allowedK_integer = np.load(folder + 'data_small_k/allowedK_integer.npy')
# allowedK_integer_path = folder + 'data_all_k_0-30/allowedK_integer.npy'
...
# allowedK_integer_30_70 = np.load(folder + 'data_all_k_30-70/allowedK_integer.npy')
# allowedK_integer = np.concatenate((allowedK_integer, allowedK_integer_30_70))
