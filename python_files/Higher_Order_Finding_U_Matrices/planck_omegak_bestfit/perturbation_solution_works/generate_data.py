...
# calculate_allowedK(params, z_rec, kvalues=kvalues_all_k30_50, folder_path=folder+'data_all_k30-50/')
# calculate_allowedK(params, z_rec, kvalues=kvalues_all_k0_30, folder_path=folder+'data_all_k0-30/')
