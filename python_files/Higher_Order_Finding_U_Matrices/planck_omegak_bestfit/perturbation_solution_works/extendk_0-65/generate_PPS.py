...
nu_spacing4_bestfit = [0.4444730086581741, -0.03940583926181416, 0.16336760287147203, 0.5615471381223595, 2.180497037062433, 0.9672453294986536, 0.07235242742234273] # cosmo_param_direc_As_ns_tau_bestfit
# nu_spacing4_bestfit = [0.45531269806747615, -0.0397827163256654, 0.15804679013016237, 0.5647692899377309, 2.1259161237019573, 0.9684295926650386, 0.052581245881857024] # cosmo_param_direc_As_ns_tau_bestfit_OmegabStep
# nu_spacing4_bestfit = [0.45531269806747615, -0.0397827163256654, 0.15804679013016237, 0.5647692899377309, 2.068999, 0.977273, 0.051376] # cosmo_param_direc_PlanckMCMC
...
data_dir = f'./data_{name_str}'
figures_dir = f'./figures_2D_dk_penalty_{name_str}'
...
if __name__ == "__main__":
    ...
    # ── Load k values ─────────────────────────────────────────────────────────
    k_vals_int = np.load(f'{data_dir}/data_integerK/L70_kvalues.npy')
    ...
    dat_path = f'../PPS_CMB/_pps_external_{name_str}_As_ns_tau_bestfit.dat'
