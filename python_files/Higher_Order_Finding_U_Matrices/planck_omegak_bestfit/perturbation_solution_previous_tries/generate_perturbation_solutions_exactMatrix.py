...
def dX_boltzmann_s(t, X, k):
    ...
    last_deriv = k*X[(num_variables_boltzmann-1)-1] - (((num_variables_boltzmann-1)-5 + 1)*X[(num_variables_boltzmann-1)])/t
...
plt.savefig(folder_path + 'perturbation_solutions_exactMatrix.pdf')
plt.show()