...
folder_path_matrices = './data/best-fit_nu_spacing4_allowedK/' # For X1, X2, recValues
folder_path_timeseries = './data/best-fit_nu_spacing4_allowedK_timeseries/' # For solution histories
...
kvalues = np.load(folder_path_matrices+'allowedK.npy')
...
np.save(folder_path_timeseries + 't_grid.npy', t_grid)

# Save the solution tensors
np.save(folder_path_timeseries + 'L70_kvalues.npy', kvalues)
np.save(folder_path_timeseries + 'L70_ABC_solutions.npy', all_ABC_solutions)
np.save(folder_path_timeseries + 'L70_DEF_solutions.npy', all_DEF_solutions)
