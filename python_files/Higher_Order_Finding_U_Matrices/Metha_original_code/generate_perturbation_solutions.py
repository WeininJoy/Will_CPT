...
for i in range(num_modes_to_plot):
    ...
    # --- b) Solve for X_inf ---
    GX3 = np.zeros((6,4))
    # Linear interpolation for GHI vector
    ...
    symm[[5, 6]] = -1  # vm and fr2 are antisymmetric
...
fig.suptitle('Evolution of Perturbation Solutions for Allowed Modes (Metha Original)', fontsize=16)
fig.tight_layout(rect=[0, 0.03, 1, 0.96])

plt.savefig('perturbation_solutions.pdf')
plt.show()