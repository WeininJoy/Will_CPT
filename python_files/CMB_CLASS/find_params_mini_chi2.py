...
def find_max_tried_num():
    ...
    directory = "/home/wnd22/rds/hpc-work/Will_CPT/CMB_CLASS/data/best-fit_params/"
...
import os.path
bestfit_file_root = '/home/wnd22/rds/hpc-work/Will_CPT/CMB_CLASS/data/best-fit_params/bestfit_params.txt'
...
for i in range(len(mt_list)):
    for j in range(len(kt_list)):
        ...
        try:
            ...
            deltaK_list.append(deltaK_list[-1]) # fill the value by its neighbor
...
def run_TT(find_params, bestfit_file_root):
    ...
    try:
        ...
        if np.isnan([val for val in cls.values()]).any(): # if there is any Nan in cls -> raise CosmoComputationError
            ...
            global try_num
            filename = f'/home/wnd22/rds/hpc-work/Will_CPT/CMB_CLASS/data/best-fit_params/try_params_{try_num}.txt'
